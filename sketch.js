...
var border,canvas;
function preload() {
  spaceImage = loadImage("space123.jpg");
  spaceShipImage = loadImage("ship12.png");
  laserImage = loadImage("blue.png");
  asteroid1 = loadImage("download (2).jpg");
  asteroid2 = loadImage("download.jpg");
  asteroid3 = loadImage("download (1).jpg");
  blastImage = loadImage("blast.jpg");
  explosionImage = loadImage("explosion.jpg");
  explosionSound = loadSound("blast.mp3");
...
function setup() {  
  ...
  border = createSprite(250,700,500,5);
...
function draw() {
  ...
  if(gameState === instruction) {
    text("  press 't' to start game.",canvas.width/2,canvas.height/2-10);
